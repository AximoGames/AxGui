 ...
 */
        ...
        protected internal override void CallComputeBounds(GlobalProcessLayoutContext ctx)
        {
            var c = ProcessLayoutContext;
            c.GlobalContext = ctx;
...
#pragma warning restore HAA0601 // Value type to reference type conversion causing boxing allocation
        ...
        protected internal override Box GetRelativeParentRect(ProcessLayoutContext ctx)
        {
        ...
        protected internal override Element? GetRelativeParent(ProcessLayoutContext ctx)
        {
            var p = Parent;
        ...
        private protected Size GetConsumedParentSize(ProcessLayoutContext ctx)
        {
            if (Parent == null)
                return default;
        ...
        private protected Box GetChildsBounds()
        {
            var childs = Children;
            var len = childs.Count;
            if (len == 0)
        ...
        protected internal override Box GetBorderBounds()
        {
            if (!PassThrough)
                return MarginRect;
        ...
        protected internal override Box GetParentBlockBox(ProcessLayoutContext ctx)
        {
            var el = GetParentBlockElement(ctx);
            if (el == null)
                return ctx.GlobalContext!.GlobalViewPort;
        ...
        private protected const byte DebugAlpha = 255;
        ...
        protected internal override void CallRender(GlobalRenderContext ctx)
        {
            var c = RenderContext;
            c.GlobalContext = ctx;
        ...
        private protected SKPaint Paint = new SKPaint();
